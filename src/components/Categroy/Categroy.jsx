...
export default class Categtoy extends Component {
  render() {
    return <>
    ...
    <div className="container py-5">
      <div className="text-center pt-4">
        ...
        <div className="Contact_aft__6e0Cw">
          <div className="Contact_aft1__yH0U0">
            </div><i className="fa-solid fa-star"></i>
            <div className="Contact_aft3__JyDcd"></div>
            </div>
            </div>
            < div  className="w-50 py-5 mx-auto  mt-5 ng-pristine ng-valid ng-touched">
